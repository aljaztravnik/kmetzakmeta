    ...
    public static class DbInitializer
    {
        public static void Initialize(KmetContext context)
        {
            ...
            var kategorijeStrojev = new KategorijaStroja[]
            {
                ...
                new KategorijaStroja{MachineType="Bager"},
                new KategorijaStroja{MachineType="Viličar"},
                new KategorijaStroja{MachineType="Prikolica"},
                new KategorijaStroja{MachineType="Plug"},
                new KategorijaStroja{MachineType="Brane"},
                new KategorijaStroja{MachineType="Valjarj"},
                new KategorijaStroja{MachineType="Rahljalnik"},
                new KategorijaStroja{MachineType="Sejalnik"},
                new KategorijaStroja{MachineType="Mešalnik"},
                new KategorijaStroja{MachineType="Sadilnik"},
                new KategorijaStroja{MachineType="Škropilnik"},
                new KategorijaStroja{MachineType="Mulčer"},
                new KategorijaStroja{MachineType="Kosilnica"},
                new KategorijaStroja{MachineType="Obračalnik"},
                new KategorijaStroja{MachineType="Zgrabljalnik"},
                new KategorijaStroja{MachineType="Nakladalna prikolica"},
                new KategorijaStroja{MachineType="Balirka"},
                new KategorijaStroja{MachineType="Ovijalka"},
                new KategorijaStroja{MachineType="Vilice"},
                new KategorijaStroja{MachineType="Kombajn"},
                new KategorijaStroja{MachineType="Krmilno-mešalna prikolica"},
            };
